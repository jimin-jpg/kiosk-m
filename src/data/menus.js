...
export const menus = [
  ...
  { id: 104, categoryId: 1, name: '바닐라라떼', price: 5500, image: '/public/vanila_latte.png', description: '달콤한 바닐라 시럽', soldOut: false },
  ...
  { id: 202, categoryId: 2, name: '녹차라떼', price: 5500, image: '/public/matcha_latte.png', description: '고소한 녹차', soldOut: false },
  ...
  { id: 304, categoryId: 3, name: '플레인요거트', price: 5800, image: '/public/plane_yougart.png', description: '깔끔한 요거트', soldOut: false },
  { id: 305, categoryId: 3, name: '초코스무디', price: 6500, image: '/public/choco_smoothie.png', description: '진한 초코', soldOut: false },

  // ── 디저트 ──
  { id: 401, categoryId: 4, name: '치즈케이크', price: 6000, image: '/public/cheeze_cake.png', description: '부드러운 뉴욕 치즈케이크', soldOut: false },
  { id: 402, categoryId: 4, name: '티라미수', price: 6500, image: '/public/tiramisu.png', description: '이탈리안 정통 티라미수', soldOut: false },
  { id: 403, categoryId: 4, name: '크로플', price: 5500, image: '/public/crople.png', description: '바삭한 크로아상 와플', soldOut: false },
  { id: 404, categoryId: 4, name: '쿠키', price: 3500, image: '/public/cookie.png', description: '수제 초코칩 쿠키', soldOut: false },

  // ── 푸드 ──
  { id: 501, categoryId: 5, name: '햄치즈샌드위치', price: 7000, image: '/public/sandwitch.png', description: '신선한 햄과 치즈', soldOut: false },
  { id: 502, categoryId: 5, name: '베이글', price: 5000, image: '/public/beigle.png', description: '쫄깃한 베이글', soldOut: false },
  { id: 503, categoryId: 5, name: '에그타르트', price: 4500, image: '/public/eggtart.png', description: '포르투갈식 에그타르트', soldOut: false },
];